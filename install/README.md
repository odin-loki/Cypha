...
Prebuilt native installers: **[GitHub Releases — latest `v2.2.5`](https://github.com/odin-loki/Cypha/releases/latest)** (`cypha-*-linux-x86_64.tar.gz`, `cypha-*-windows-x86_64.zip`).

```bash
# Linux (example)
tar xzf cypha-2.2.5-linux-x86_64.tar.gz && cd cypha-2.2.5-linux-x86_64 && bash install.sh
```

```powershell
# Windows (example)
Expand-Archive cypha-2.2.5-windows-x86_64.zip
cd cypha-2.2.5-windows-x86_64
