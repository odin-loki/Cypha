...
Prebuilt installers: **[GitHub Releases `v2.4.0`](https://github.com/odin-loki/Cypha/releases/tag/v2.4.0)** — `cypha-2.4.0-linux-x86_64.tar.gz`, `cypha-2.4.0-windows-x86_64.zip` (MSVC), optional **`cypha-2.4.0-linux-x86_64.AppImage`** (Qt shell), **`cypha-2.4.0-arxiv-bundle.zip`** (paper figures).
