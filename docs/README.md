...
| [Numerical audit](reports/NUMERICAL_KERNEL_AUDIT_2026-09-17.md) | 20 hand-verified defects in the inference gate and numerical kernels. **R1 fixed**, **R3/R4 pinned** by CTest; R2/R3/R4 open as port-contract decisions; 13 latent |
