# Stream Cypha sequence generation (SSE) from native cypha_rest (port 8099).
# Requires Cypha sequence at startup: --sequence-checkpoint or CYPHA_SEQUENCE_CHECKPOINT
