// kernel_llr_golden vs fixtures/kernel_llr/sidecar.json
#include <cmath>
#include <fstream>
#include <iostream>
#include <map>
...
int main(int argc, char** argv) {
  try {
    if (argc != 2) {
      std::cerr << "usage: kernel_llr_golden <fixtures/kernel_llr/sidecar.json>\n";
      return 2;
    }
    ...
    std::cerr << "kernel_llr_golden: " << e.what() << "\n";
    return 1;
  }
}
