...
**GitHub Actions (optional job):** **`ilammy/msvc-dev-cmd`** + **Visual Studio generator** (`cmake -A x64 -DCYPHA_ENABLE_CUDA=ON -DCMAKE_CUDA_COMPILER=%CUDA_PATH%\bin\nvcc.exe`); configure/build/ctest use `-C Release`. See [`.github/workflows/ci.yml`](../../.github/workflows/ci.yml) job `windows_cuda_msvc`.
