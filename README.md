...
[![CI](https://github.com/odin-loki/Cypha/actions/workflows/ci.yml/badge.svg)](https://github.com/odin-loki/Cypha/actions/workflows/ci.yml) · **[Releases](https://github.com/odin-loki/Cypha/releases)** (native Linux/Windows installers — latest **v2.2.6**)
...
(Full inventory in [`native/README.md`](native/README.md). CI gate: **52 CTest** + **~274 pytest** on Linux; native parity subprocess suite on Windows via `scripts/cypha_native_validate_all.ps1`.)
