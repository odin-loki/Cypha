...
struct DecodeParams {
    ...
    /// Keep learning from the model's own generated bytes (hp online update, the
    /// default). Off: generated bytes advance the context but change no learned
    /// statistic. Measured worse for this model (it loops or drifts without
    /// adapting to the text it is writing); see CYPHALM_LM_QUALITY_REPORT.md.
    bool learn_from_output = true;
