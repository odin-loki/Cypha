...
| Doc | Topic | Status |
|-----|--------|--------|
| [RPSM_COMBINED_SPEC.md](RPSM_COMBINED_SPEC.md) | Option A (CyphaDIF matrix refactor) + Option B (RPSM sequence layer), execution order, D17 BPC target | **STOP** — closed per BoW; historical target 2.873; living pin **2.664** |
