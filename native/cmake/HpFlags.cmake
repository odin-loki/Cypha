...
#   Lab RSS ~1.6 GB @ mem 22 (hp/tools/hp_harness.sh RECORD H34).
# champ: v78_flags.ps1 feature set + HP_SLOT_MAX=35 (~15 GB @ mem 22).
#   mem-26-class: -DCYPHA_HP_PROFILE=champ -DCYPHA_HP_SLOT_MAX=31

set(CYPHA_HP_PROFILE "light" CACHE STRING
  "hp compile profile: light (default, SLOT_MAX=24) or champ (v78 + SLOT_MAX=35)")

set(CYPHA_HP_SLOT_MAX 24 CACHE STRING
  "hp HP_SLOT_MAX compile cap (24=light, 35=champ default, 31=mem-26-class)")
...
if(NOT CYPHA_HP_PROFILE STREQUAL "light" AND NOT CYPHA_HP_PROFILE STREQUAL "champ")
  message(FATAL_ERROR
    "CYPHA_HP_PROFILE must be 'light' or 'champ' (got '${CYPHA_HP_PROFILE}')")
endif()
...
# Parse HP compile defs from vendored v78_flags.ps1 (champ profile only).
...
if(CYPHA_HP_PROFILE STREQUAL "champ")
  ...
  message(STATUS "CYPHA_HP_PROFILE=champ: ${_CYPHA_V78_N} v78 feature defs from v78_flags.ps1")
endif()
