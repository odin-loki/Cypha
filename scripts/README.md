...
| `ci_native_linux.sh` | Linux/WSL mirror of CI **`build_and_test`** native step: cmake + CTest + optional drift pytest | console |
| `cypha_native_validate_all.ps1` | Windows full gate: rebuild + 52 CTests + native pytest + bench fig01–09 + tune dry-run + REST smoke (`-SkipBuild` after rebuild) | console |
