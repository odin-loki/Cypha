...
| 4 BPE LM | `scripts/train_wikitext_bpe.py`, profile `d17_bpe` | BPC@5k < 4.04 | **FAIL on real WikiText** — m300 vocab427: `5.12`@5k, `4.79`@30k (sample-BPE `3.82` was an artifact). Path kept for overnight stretch |
