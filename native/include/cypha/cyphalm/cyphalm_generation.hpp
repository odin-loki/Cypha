...
struct DecodeParams {
    ...
    /// Add generated bytes to the match-model history index (default). Off: the
    /// model can still continue a copy it started in the prompt, but cannot
    /// adopt its own output as a copy source (breaks self-copy loops).
