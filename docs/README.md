...
| [Numerical audit](reports/NUMERICAL_KERNEL_AUDIT_2026-09-17.md) | 20 hand-verified defects in the inference gate and numerical kernels. **R1/R3/R4 fixed** and CTest-guarded; R2 open (needs a design call); 13 latent |
